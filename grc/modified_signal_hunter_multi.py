...
# Title: Signal Hunter Multi
# Author: @billautomata
# Description: yes
# Generated: Wed Aug 24 07:19:06 2016
##################################################
...
class signal_hunter_multi(grc_wxgui.top_block_gui):

    def __init__(self, queue):
        grc_wxgui.top_block_gui.__init__(self, title="Signal Hunter Multi")
        ...
        # self.fft_taps = fft_taps = filter.optfir.low_pass(1.0, self.samp_rate, 11000, 12500, 0.1, 60)
        ...
        self.flex = pager.flex_demod(queue, 0, True, True) # options.verbose, options.log
        ...
        # FLEX demod connection
        self.connect((self.freq_xlating_fft_filter_ccc_0, 0), (self.flex, 0))
        self.connect((self.freq_xlating_fft_filter_ccc_0, 0), (self.wxgui_waterfallsink2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.wxgui_waterfallsink2_0.set_sample_rate(self.samp_rate/self.xlate_decimation)
